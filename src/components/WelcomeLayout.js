        ...
        <div id="spalshWelcome" className={isActive ? 'profile-open' : ''}>
            <div id="welcomeText">
                ...
                <p className="greeting-text"> 
                    I’m a highly analytical and detail-oriented professional who loves mountaineering. 
                    ...
                    I thrive on turning data into actionable insights and delivering results with accuracy and clarity.
                </p>
                <ProfileIcons />
